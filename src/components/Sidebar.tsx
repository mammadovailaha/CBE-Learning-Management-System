    ...
    return (
      <div className="w-[108px] h-[calc(100vh-5vh)]  h-[95%] flex flex-col items-center bg-[#E8E8E6] rounded-[12px] p-4 mt-5  ml-3 gap-6 transition-all delay-150 duration-300 ease-in-out">
        ...
        <div className="w-11 h-32 flex flex-col justify-center items-center gap-[25px] border-b border-[#BEBFC1]">
          ...
          <button className="w-11 h-11 rounded-[12px] outline-none border-none bg-[#2463EB] hover:bg-[#1A52CA] transition-all delay-150 duration-300 ease-in-out flex justify-center items-center cursor-pointer">
            <img className="w-6 h-6 object-cover" src={addBox} alt="add" />
          </button>
        </div>
        {/* Icons */}
        <div className="flex flex-col items-center gap-4">
           <button  className="w-11 h-9 outline-none border border-transparent bg-transparent flex justify-center items-center cursor-pointer hover:bg-[#D7D8D5] hover:border-[#5B5757] rounded-[8px] transition-all delay-150 duration-300 ease-in-out">
            <img
